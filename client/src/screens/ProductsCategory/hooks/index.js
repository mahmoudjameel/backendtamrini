...
const useProductsHook = () => {
  ...
  const deleteProduct = async _id => {
    try {
      let response = await axios.post("/api/product-categories/delete", { _id });
      let data = await response.data;
  ...
  const addProduct = async formRef => {
    try {
      ...
      let response = await axios.post("/api/product-categories/add", productData);
      let data = await response.data;
  ...
  const editProduct = async formRef => {
    try {
      ...
      let response = await axios.post("/api/product-categories/edit", productData);
      let data = await response.data;
